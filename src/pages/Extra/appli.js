...
//         <div className='container'>
//             <div className='row mt-4 justify-content-center'>
//                 <div className='col-sm-2' style={{ background: '#0a1e25', boxShadow: '5px 10px #dcd7cb', borderRadius: '8px 0 0 8px' }}></div>
//                 <div className='col-sm-10' style={{ maxHeight: '80vh', maxWidth: '80vh', background: '#e6e6e6', boxShadow: '5px 10px #dcd7cb', borderRadius: '0 8px 8px 0' }}>
//                     <h2 className='mt-3 mb-4'>Apply <b style={{ color: '#0a1e25' }}>Internship</b></h2>
//                     <form onSubmit={handleSubmit}>
//                         <div className='mt-2 col-sm-12'>
...
//                             <div className='mt-2 col-sm-6'>
//                                 <label style={{ fontSize: '18px' }}>Languages</label>
//                                 <input className='border shadow-md border-grey-400 py-1 px-2 rounded-2 form-control' type='text' name='languages' value={formData.languages} onChange={handleChange} />
//                             </div>
//                             <div className='mt-2 col-sm-6'>
//                                 <label style={{ fontSize: '18px' }}>Skills</label>
//                                 <input className='border shadow-md border-grey-400 py-1 px-4 form-control rounded-2' type='text' name='skills' value={formData.skills} onChange={handleChange} />
//                             </div>
//                             <div className='mt-2 col-sm-6'>
