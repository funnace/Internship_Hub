...
export const Apply = (props) => {
  ...
  //   formDataToUpload.append('file', formData.resume);
  //   formDataToUpload.append('upload_preset', 'pdfupload');

  //   try {
  //     const cloudinaryResponse = await axios.post(
  //       `https://api.cloudinary.com/v1_1/dqyra3hfe/upload`,
  //       formDataToUpload
  //     );

  //     const resumeUrl = cloudinaryResponse.data.secure_url;

  //     // Add the resume URL to the form data
  ...
  return (
    <div className='container mb-5' style={{marginTop: '17vh'}}>
    <div className='row mt-4 justify-content-center'>
    <div className='col-sm-2 ' style={{background:'#0a1e25',boxShadow:'5px 10px #dcd7cb', borderRadius: "8px 0 0 8px"}}>
 </div>  
<div className='col-sm-10' style={{maxHeight: '100h', maxWidth: '37vw',  background:'#e6e6e6', boxShadow:'5px 10px #dcd7cb', borderRadius: "0 8px 8px 0"}}>
      ...
      <div className='mt-2 col-sm-12'>
       ...
       <div className='mt-2 col-sm-6'>
         <label style={{fontSize:'18px'}}>Course</label>
        
         <input  className ='border shadow-md border-grey-400 py-1 px-2  rounded-2 form-control'  type="text" name="course" value={formData.course} onChange={handleChange} />
        
       </div>
       <div className='mt-2 col-sm-6'>
         <label style={{fontSize:'18px'}}>Specialization</label>
         <input  className ='border shadow-md border-grey-400 py-1 px-4  form-control  rounded-2' type="text" name="specialization" value={formData.specialization} onChange={handleChange} />
       </div>
       <div className='mt-2 col-sm-6'>
         <label style={{fontSize:'18px'}}>CGPA</label>
        
         <input  className ='border shadow-md border-grey-400 py-1 px-2  rounded-2 form-control'  type="number" name="CGPA" value={formData.CGPA} onChange={handleChange} />
        
       </div>
       <div className='mt-2 col-sm-6'>
         <label style={{fontSize:'18px'}}>Upload Resume</label>
